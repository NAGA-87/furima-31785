...
ActiveRecord::Schema.define(version: 2020_11_22_062941) do
  ...
  create_table "delivery_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["record_id"], name: "index_delivery_addresses_on_record_id"
  end
  ...
  add_foreign_key "delivery_addresses", "records"
